...
/// See also:
///
///   * [ShapleAuth], the instance used to manage authentication
...
class HiveLocalStorage extends LocalStorage {
  ...
  Future<String?> accessToken() {
    return Future.value(
      Hive.box(_hiveBoxName).get(shaplePersistSessionKey) as String?,
    );
  }

  @override
  Future<void> removePersistedSession() {
    return Hive.box(_hiveBoxName).delete(shaplePersistSessionKey);
  }
  ...
  Future<void> persistSession(String persistSessionString) {
    ...
    return Hive.box(_hiveBoxName)
        .put(shaplePersistSessionKey, persistSessionString);
  }
}
